...
class SearchWidgetView @JvmOverloads constructor(
...
) : FrameLayout(context, attrs, defStyle), ThemeManager.ThemeChangeListener {
    ...
    private val isGoogleInstalled = SuperiorUtils.isPackageInstalled(context, Utilities.GSA_PACKAGE)
    ...
    override fun onAttachedToWindow() {
        ...
        setClickListeners()
        ThemeManager.INSTANCE.get(context).addChangeListener(this)
        updateColors()
    }
    ...
    fun updateColors() {
        ...
        if (themeManager.isMonoThemeEnabled) {
    ...
    override fun onDetachedFromWindow() {
        ThemeManager.INSTANCE.get(context).removeChangeListener(this)
